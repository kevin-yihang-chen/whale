...
#SBATCH --job-name=whale-initialization-audit
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/canonical-initialization-finalization-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.finalize_canonical_initialization --plan "$1"
