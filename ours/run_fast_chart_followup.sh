...
#SBATCH --job-name=veto-chart-followup
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/fast-chart-followup-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.fast_chart_followup run --plan "$1"
