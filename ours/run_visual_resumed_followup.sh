...
#SBATCH --job-name=veto-resumed-followup
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/visual-resumed-followup-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.visual_resumed_followup --phase run --plan "$1"
