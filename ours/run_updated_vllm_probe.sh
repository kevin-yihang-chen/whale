...
#SBATCH --job-name=whale-updated-vllm
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/updated-vllm-handoff-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.probe_updated_vllm --plan "$1"
