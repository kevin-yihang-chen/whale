...
#SBATCH --job-name=whale-joint-phase2
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/controlled-joint-phase2-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.joint_training_phase2 --phase run --plan "$1"
