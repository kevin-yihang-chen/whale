...
#SBATCH --job-name=veto-visual-followup
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/visual-followup-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.native_visual_followup --phase run --plan "$1"
