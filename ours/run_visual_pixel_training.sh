...
#SBATCH --job-name=veto-pixel-rsft
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/visual-pixel-rsft-%j.log
...
export WHALE_TRIAL_SEED=42 PYTHONHASHSEED=42
...
exec data/training-runtime-v1/bin/python -m ours.visual_pixel_training --phase run --plan "$1"
