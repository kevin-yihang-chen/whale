...
#SBATCH --job-name=whale-trial-seeds
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/trial-randomization-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.probe_trial_randomization --plan "$1"
