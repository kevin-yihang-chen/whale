...
#SBATCH --job-name=veto-visual-repeat
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/visual-repeat-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.visual_followup_repeatability --phase run --plan "$1"
