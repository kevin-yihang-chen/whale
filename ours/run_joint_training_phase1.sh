...
#SBATCH --job-name=whale-joint-phase1
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/controlled-joint-phase1-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.joint_training_phase1 --phase run --plan "$1"
