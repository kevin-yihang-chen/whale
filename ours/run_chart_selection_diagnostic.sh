...
#SBATCH --job-name=veto-selection-R512
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/chart-selection-diagnostic-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.chart_selection_diagnostic run-suite --plan "$1"
