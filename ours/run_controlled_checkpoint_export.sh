...
#SBATCH --job-name=whale-controlled-export
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/controlled-checkpoint-export-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.controlled_checkpoint_export --phase run --plan "$1"
