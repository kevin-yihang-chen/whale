...
#SBATCH --job-name=whale-updated-mh
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/updated-mh-%j.log
...
test "$#" = 2
case "$2" in baseline|candidate) ;; *) exit 2 ;; esac
...
exec data/training-runtime-v1/bin/python -m ours.mh_phase --plan "$1" --phase "$2"
