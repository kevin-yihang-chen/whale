...
#SBATCH --job-name=veto-visual-candidate
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/visual-candidate-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.visual_search_evaluation --phase run --plan "$1"
