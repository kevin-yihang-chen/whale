...
#SBATCH --job-name=whale-alternation-export
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/alternation-checkpoint-export-%j.log
#SBATCH --mail-user=kevin.yihang.chan@gmail.com
#SBATCH --mail-type=ALL
#SBATCH --no-requeue
# E4 canonical serialization and exact parameter audit execute on CPU.
set -euo pipefail
...
exec data/training-runtime-v1/bin/python -m ours.alternation_checkpoint_export --plan "$1"
