...
#SBATCH --job-name=whale-alternation-replay
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/alternation-recovery-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.alternation_recovery --plan "$1" --run
