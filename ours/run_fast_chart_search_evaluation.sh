...
#SBATCH --job-name=veto-chart-search
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/fast-chart-search-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.fast_chart_search_evaluation run --plan "$1"
