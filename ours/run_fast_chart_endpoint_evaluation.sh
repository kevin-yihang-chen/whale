...
#SBATCH --job-name=veto-chart-endpoint
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/fast-chart-endpoint-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.fast_chart_endpoint_evaluation run --plan "$1"
