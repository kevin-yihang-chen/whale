...
#SBATCH --job-name=whale-common-initialization
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/canonical-initialization-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.canonical_initialization --plan "$1"
