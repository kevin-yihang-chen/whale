...
def submit(path, phase, kind='evaluation'):
    ...
    receipt = {'plan': str(path), 'plan_sha256': file_sha256(path), 'protocol_sha256': file_sha256(PROTOCOL),
        ...
        'gpu_choice': 'Native RSFT uses one actor and one rollout GPU; standalone inference uses one GPU with batch8.',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--kind', choices=('evaluation','training','followup','search','endpoint'), default='evaluation')
