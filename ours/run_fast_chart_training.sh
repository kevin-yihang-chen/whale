...
#SBATCH --job-name=veto-chart-rsft
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/fast-chart-training-%j.log
...
test "$#" = 2
case "$2" in 42|43|44) ;; *) exit 2 ;; esac
...
export WHALE_TRIAL_SEED="$2" PYTHONHASHSEED="$2"
...
exec data/training-runtime-v1/bin/python -m ours.fast_chart_training run --plan "$1"
