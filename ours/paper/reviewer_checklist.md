...
| Can each headline claim be traced? | Three complete result tables, three evidence figures, success/failure cases, raw-result identities, reproducible commands, main/supplement sources and claim-to-evidence index. | v19 includes the complete seed42 native cycle:216 accepted trajectories,28 updates and V447/512,212/256. Three stages and raw scores were reconstructed; final method tables/curves remain incomplete. Case shows an operand-order error, not demonstrated visual non-use. |
| Is the submission package current and authorized? | Recheck official2027 formatting before submission. Exclude secrets, raw model/data artifacts and runtime caches from publication; obtain separate approval for GitHub push or submission. | The explicitly authorized public GitHub snapshot3316d97 contains the September15 code/progress and incomplete v15 draft. September16 results and v19 remain local; no submission has occurred. |
