...
#SBATCH --job-name=veto-native-visual
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/native-visual-service-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.native_visual_service --phase run --plan "$1"
