...
#SBATCH --job-name=veto-visual-resume
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/visual-resume-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.visual_training_resume --phase run --plan "$1"
