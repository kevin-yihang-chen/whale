...
#SBATCH --job-name=whale-joint-mh
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/controlled-mh-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.joint_staged_search --plan "$1" --phase evaluate --evaluation "$2"
