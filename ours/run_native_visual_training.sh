...
#SBATCH --job-name=veto-visual-rsft
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/visual-rsft-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.native_visual_training --phase run --plan "$1"
