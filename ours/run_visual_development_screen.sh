...
#SBATCH --job-name=veto-visual-development
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/visual-development-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.visual_development_screen --phase run --plan "$1"
