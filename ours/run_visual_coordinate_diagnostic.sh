...
#SBATCH --job-name=veto-visual-coordinate
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/visual-coordinate-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.visual_coordinate_diagnostic --phase run --plan "$1"
