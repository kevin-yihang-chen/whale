...
#SBATCH --job-name=whale-controlled-pilot
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/controlled-pilot-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.controlled_pilot_continuation --phase run --plan "$1"
