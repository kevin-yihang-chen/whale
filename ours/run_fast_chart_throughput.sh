...
#SBATCH --job-name=veto-chart-throughput
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/fast-chart-throughput-%j.log
...
export TRITON_CACHE_DIR="$PWD/data/fast-chart-20260915-v1/runtime-cache/triton"
export VLLM_CACHE_ROOT="$PWD/data/fast-chart-20260915-v1/runtime-cache/vllm"
export FLASHINFER_WORKSPACE_BASE="$PWD/data/fast-chart-20260915-v1/runtime-cache/flashinfer"
export HF_DATASETS_CACHE="$PWD/data/fast-chart-20260915-v1/runtime-cache/datasets"
export XDG_CACHE_HOME="$PWD/data/fast-chart-20260915-v1/runtime-cache/xdg"
exec data/training-runtime-v1/bin/python -m ours.fast_chart_throughput run --plan "$1"
