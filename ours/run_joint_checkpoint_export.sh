...
#SBATCH --job-name=whale-joint-export
#SBATCH --output=/userhome/cs3/yihangc/Documents/whale-delta/results/joint-checkpoint-export-%j.log
...
exec data/training-runtime-v1/bin/python -m ours.joint_checkpoint_export --phase run --plan "$1"
